...
<html>
  <head>
    ...
    <!-- Your own stylesheet -->
    <link rel="stylesheet" type="text/css" href="getstartedcss.css">
  </head>
  <body>
    ...
    <div class="container d-flex align-items-center h-100" >
      <div class="row">
        <header class="text-center col-10">
  <h1 class="text-uppercase"><strong>AGROWCULTURE</strong></h1>
  <h4><strong>Get in the world of investments by helping the poor farmers of the country.</strong></h4>
</header>
<div class="buffer col-2"></div>
<section class="text=center">
  <hr>
  <a href="4optionss.php"><button class="btn btn-light btn-xl">GET STARTED</button></a>
  </section>
</div>  
</div>
<footer>
  ...
  <p>2022 Copyright © AgrowCulture. | Legal | Privacy Policy | Designed by Namiha</p>
</footer>
