     ...
     <div class="product-container">
        <div class="product-card">
            ...
            <div class="product-info">
               ...
               <a href="product.php"><button class="button-68" role="button">Details</button></a>
            </div>
        </div>
        ...
        <div class="product-card">
            ...
            <div class="product-info">
               ...
               <a href="product.php"><button class="button-68" name="#" role="button">Details</button></a>
            </div>
        </div>
    
        <div class="product-card">
            <div class="product-image">
                <img src="potato.jpg" height="350px" width="450px" class="product-thumb" alt="">
                <a class="add-cart" href="#">Add to cart</a> 
            </div>
            <div class="product-info">
                <h2 class="product-brand">POTATO</h2>
       
                <span class="price">33Tk/kg</span><br>
                <a href="product.php"><button class="button-68" role="button">Details</button></a>
