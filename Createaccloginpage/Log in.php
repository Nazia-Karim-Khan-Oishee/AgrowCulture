    ...
    <div class="container1">
        ...
        <div class="titleDiv">
            ...
            <div class="form__input-group">
                <input type="text" class="form__input"  name="username" id="username" autofocus placeholder="Enter username" required>
                <div class="form__input-error-message"></div>
            </div>

            <div class="form__input-group">
                <input type="password" class="form__input" name="password" id="password" autofocus placeholder="Enter password" required>
                <div class="form__input-error-message"></div>
            </div>
                ...
                <p class="form__text">Don't have an account?
                    <a href="create acccount.html">Create account</a>
                </p>
            </form>         
        </div>
    </div>
